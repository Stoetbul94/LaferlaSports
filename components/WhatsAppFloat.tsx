...
/**
 * Persistent floating WhatsApp button (bottom-right) shown on every page.
 * WhatsApp is the dominant enquiry channel for this market.
 */
export default function WhatsAppFloat() {
  return (
    <a
      href={whatsappUrl('Hi Laferla Sports, I have a question about your ISSF shooting equipment.')}
      target="_blank"
      rel="noopener noreferrer"
      aria-label="Chat with us on WhatsApp"
      className="group fixed bottom-5 right-5 z-50 flex items-center gap-3 rounded-full bg-[#25D366] py-3 pl-3 pr-4 text-white shadow-xl shadow-black/30 ring-1 ring-black/10 transition-transform duration-200 hover:scale-105 print:hidden"
    >
      <svg
