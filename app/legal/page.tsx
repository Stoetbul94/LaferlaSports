        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="prose prose-lg max-w-none">
            <section className="mb-8">
              <h2 className="heading-3 mb-4">1. Order Requests</h2>
            ...
            <section className="mb-8">
              <h2 className="heading-3 mb-4">2. Pricing</h2>
              <p className="text-body mb-4">
            ...
            <section className="mb-8">
              <h2 className="heading-3 mb-4">3. Payment</h2>
              <p className="text-body mb-4">
            ...
            <section className="mb-8">
              <h2 className="heading-3 mb-4">4. Shipping & Delivery</h2>
              <p className="text-body mb-4">
            ...
            <section className="mb-8">
              <h2 className="heading-3 mb-4">5. Returns & Refunds</h2>
              <p className="text-body mb-4">
                Returns are accepted within 14 days of delivery, subject to the following conditions:
              </p>
              <ul className="list-disc list-inside space-y-2 text-body text-primary-700 mb-4">
            ...
            <section className="mb-8">
              <h2 className="heading-3 mb-4">6. Product Information</h2>
              <p className="text-body mb-4">
            ...
            <section className="mb-8">
              <h2 className="heading-3 mb-4">7. ISSF Compliance</h2>
              <p className="text-body mb-4">
            ...
            <section>
              <h2 className="heading-3 mb-4">9. Contact</h2>
              <p className="text-body">
